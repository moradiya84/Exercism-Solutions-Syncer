...
def value_of_ace(card_one, card_two):
    ...
    """
    if(value_of_card(card_one)+value_of_card(card_two)+11+(10*(value_of_card(card_one)==1))+(10*(value_of_card(card_two)==1))>21):
        return 1
    else:
        return 11
...
def is_blackjack(card_one, card_two):
    ...
    """
    return (value_of_card(card_one)+value_of_card(card_two)==11 and min(value_of_card(card_one),value_of_card(card_two))==1)
